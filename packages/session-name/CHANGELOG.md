...
- 9721370: Fix model fallback and OAuth auth support in recap and session-name
...
- c477a91: Use the host's own name in the terminal title instead of hardcoding "Pi"
