...
- 63683e3: Expose an optional session-scoped artifacts service for direct HTML publishing, question answers, and owned async feedback. Preserve the ordinary tool route and prevent concurrent feedback delivery from duplicating or erasing drafts.
