...
| [intercom](packages/intercom/)       | Brokerless session-to-session messaging — file mailbox that outlives the process; drop-in pi-intercom replacement                                 | `intercom` tool, `/intercom`                 |
